...
tg_sendinfo "<code>I am gonna merge staging into Exvop-Userbot</code>"
cd
...
git push --force origin staging:Exvop-Userbot
tg_sendinfo "<code>I have merged all commits from staging into Exvop-Userbot</code>"
