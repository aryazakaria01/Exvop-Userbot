...
async def amireallyalive(alive):
    ...
    output = (
        f"**ㅤㅤ  ╭─━━═━═━═━═━━─╮**\n"
        f"**       ⊏┊[⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡](t.me/LynxUserbot) ⊨〛💨 **\n"
        f"**ㅤㅤ  ╰─━━═━═━═━═━━─╯**\n"
        f"╭╼════════════════════╾╮\n"
        ...
        f"├◈ **{LYNX_TEXT_CUSTOM}**\n"
        f"╰╼════════════════════╾╯\n"
        f"| [𝗥𝗲𝗽𝗼](https://aryazakaria01.github.io/Phoenix-Userbot) | [𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝗧𝗲𝗮𝗺](t.me/GeezSupportGroup) | " f"[𝗠𝘆 𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺]({INSTAGRAM_ALIVE}) | ")
...
async def amireallyalive(alive):
    ...
    await get_readable_time((time.time() - StartTime))
    output = (
        f"**ㅤㅤㅤㅤ ⚡【𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏】⚡**\n"
        f"╔══════════╣۩ ✞ ۩╠══════════╗ \n"
        f"╟⟩⟩ 🤴 • `ᴏᴡɴᴇʀ    :`[ᴀʀʏᴀ ᴢᴀᴋᴀʀɪᴀ](t.me/Badboyanim)             ㅤ ║\n"
        ...
        f"╚══════════╣۩ ✞ ۩╠══════════╝ \n"
        f"😼 : [𝗥𝗘𝗣𝗢-𝗣𝗵𝗼𝗲𝗻𝗶𝘅](https://github.com/aryazakaria01/Phoenix-Userbot)\n👥 : [𝗚𝗲𝗲𝘇-𝗧𝗘𝗔𝗠](t.me/GeezSupportGroup)\n👩‍💻 : [𝗙𝗢𝗥𝗞-𝗘𝗗𝗜𝗧𝗢𝗥](t.me/Badboyanim)\n👤 : [𝗢𝗪𝗡𝗘𝗥-𝗚𝗥𝗢𝗨𝗣](t.me/VckyouuBitch)\n"
            )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    await alive.edit("__Connecting to server..__")
    await alive.edit("__Connecting to server...__")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡              🐈")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡             🐈")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡            🐈")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡           🐈")
    ...
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡🐈")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏🐈")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊🐈⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽🐈𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍🐈𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀🐈𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎🐈𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐🐈𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅-🐈𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅🐈𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    ...
    output = (
        ...
        f"╰╼════════════════════╾╯\n"
        f"| [𝗥𝗲𝗽𝗼](https://aryazakaria01.github.io/Phoenix-Userbot) | [𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝗧𝗲𝗮𝗺](t.me/GeezSupportGroup) | 
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
