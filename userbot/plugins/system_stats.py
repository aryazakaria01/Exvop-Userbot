...
async def amireallyalive(alive):
    ...
    output = (
        f"**ㅤㅤ  ╭─━━═━═━═━═━━─╮**\n"
        f"**       ⊏┊[⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡](t.me/Badboyanim) ⊨〛💨 **\n"
        f"**ㅤㅤ  ╰─━━═━═━═━═━━─╯**\n"
        f"╭╼════════════════════╾╮\n"
...
@register(outgoing=True, pattern=r"^\.(?:aryazakaria|iam)\s?(.)?")
async def amireallyalive(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f"**ㅤㅤㅤㅤ ⚡【𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏】⚡**\n"
        f"╔══════════╣۩ ✞ ۩╠══════════╗ \n"
...
async def redis(alive):
    ...
    await alive.edit("__Connecting to server..__")
    await alive.edit("__Connecting to server...__")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡              🐈")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡             🐈")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡            🐈")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡           🐈")
    ...
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡🐈")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏🐈")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊🐈⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽🐈𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍🐈𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀🐈𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐𝙎🐈𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-𝙐🐈𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽-🐈𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼𝗽🐈𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃𝗼🐈𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅𝘃🐈𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘𝘅🐈𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗘🐈𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡🐈𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("🐈𝗘𝘅𝘃𝗼𝗽-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡")
